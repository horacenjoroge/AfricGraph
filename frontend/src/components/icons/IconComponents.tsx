// Geometric SVG icons for Intelligence Console aesthetic
...
export const BusinessIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const GraphIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <line x1="12" y1="10" x2="4" y2="4" />
    <line x1="12" y1="10" x2="20" y2="4" />
    <line x1="12" y1="14" x2="4" y2="20" />
    <line x1="12" y1="14" x2="20" y2="20" />
  </svg>
)

export const RiskIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
